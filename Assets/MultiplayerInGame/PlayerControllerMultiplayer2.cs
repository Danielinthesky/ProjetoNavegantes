...
public class PlayerControllerMultiplayer2 : MonoBehaviourPun
{
    ...
    private void Start()
{
    ...
    private void Update()
    {
        if (!photonView.IsMine) return; // Executa o movimento apenas para o segundo jogador
    ...
    {
        if (!photonView.IsMine) return; // Garante que apenas o segundo jogador manipule o input
